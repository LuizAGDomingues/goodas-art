  ...
  return (
    <div className='bg-[#63513d] h-28 w-full flex items-center justify-between text-white font-medium font-Nunito text-lg'>
      ...
      <div className='flex gap-10 mr-36'>
        <Link href='/' className='mr-10'>Login</Link href='/'>
        <Link href='/'>Artigos em couro</Link href='/'>
        <Link href='/'>Restauração de imagens</Link href='/'>
        <Link href='/' className='mr-10'>Artesanatos</Link href='/'>
