...
function Header() {
  return (
    <div className='bg-[#63513d] h-28 w-full flex items-center justify-between gap-96 text-white font-medium font-Nunito text-lg'>
      <Link href='/'>
        <a className='ml-36'>
          <Image 
            src={logo} 
      ...
      <div className='flex gap-10 mr-36'>
        ...
        <Link href='/' className='w-5'>Quem somos</Link>
