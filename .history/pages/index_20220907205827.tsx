...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      { render ? 
        <>
          <strong className='font-Nunito text-2xl'> COMENTÁRIOS </strong>
          <div className='m-28 flex items-center justify-center gap-52 font-Dancing font-bold text-2xl'>
        ...
        : <span className='font-Dancing font-bold text-2xl h-48'>loading</span>
      }
      <Footer />
    </>
  )
