...
const Home: NextPage = () => {
  ...
  const p = document.querySelector('#comentarios');
  var posicao = p?.getBoundingClientRect();
  ...
  return (
    <>
      ...
      <div id='comentarios' className='m-32 flex items-center justify-center gap-52 font-Dancing font-bold text-2xl'>
