      ...
      >
        <SwiperSlide>
          <Image
            src={imagem1}
            alt='Logo image'
            style={{transform: 'rotate(90deg)', objectFit: 'fill', width: '100vw', height: '600px'}}
          />
        </SwiperSlide>
        <SwiperSlide style={{objectFit: 'cover', width: '100vw', height: '600px'}}>
          <Image
            src={imagem2}
            alt='Logo image' 
            style={{objectFit: 'cover', width: '100vw', height: '600px'}}
          />
        </SwiperSlide>
        <SwiperSlide>
          <Image
