      ...
      <div className='flex items-center justify-between'>
        <div>
          <div className='relative'>
            <Image src={foto_mae} alt='foto de Shirlei Gooda' height={825} style={{borderRadius: '100px'}}/>
            <div className='absolute bottom-0'>
              <Image src={moldura} alt='moldura de flores' width={1000} height={900} objectFit='cover'/>
            </div>
          </div>
        </div>
