...
const Home: NextPage = () => {
  ...
  function ComentsRender(){
    var posicaoInicial = $('#comentarios').position().top;
  ...
  return (
    <>
      ...
      <div id='cometarios' className='m-32 flex items-center justify-center gap-52 font-Dancing font-bold text-2xl'>
